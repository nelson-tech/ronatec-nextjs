...
export const Overview: React.FC = () => {
  ...
  const [
    {
      "meta.title": { value: metaTitle } = {} as Fields,
      "meta.description": { value: metaDesc } = {} as Fields,
      "meta.image": { value: metaImage } = {} as Fields,
    },
  ] = useAllFormFields()
  ...
  useEffect(() => {
    if (typeof metaTitle === "string")
      setTitleIsValid(
        metaTitle.length >= minTitle && metaTitle.length <= maxTitle
      )
