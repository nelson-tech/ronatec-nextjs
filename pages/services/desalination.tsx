          ...
          <div className="text-gray-500">
            <div className="pb-4 space-y-4">
              <p>
                ...
                several processes that remove excess salt and other minerals
                from water.
              </p>
            </div>
            ...
            <div className="space-y-2 border-t pb-4">
              ...
              <ul className="list-disc ml-8 text-sm">
                <li>
                  <strong>Distillation:</strong> Boiling water and condensing
                  the vapor, leaving behind the unwanted dissolved solids.
                </li>
                <li>
            ...
            <div className="space-y-2 border-t pb-4">
              ...
              <ul className="list-disc ml-8 text-sm">
                ...
                <li>
                  ...
                  regularly run system eliminating waste disposal. All cleaning
                  is done via generation cycles and clean water produced by
                  system.
                </li>
                <li>
                ...
                <div className="py-8 lg:py-0 lg:w-1/3 lg:flex-none">
                  <div className="max-w-xs mx-auto px-4 flex items-center lg:max-w-none lg:px-8">
                    <div className="ml-4 flex-auto flex flex-col">
                      ...
                      <p className="text-sm text-gray-500">
                        Chief designer, patent holder, project manager,
                        installer.
                      </p>
                    </div>
                  </div>
                ...
                <div className="py-8 lg:py-0 lg:w-1/3 lg:flex-none">
                  <div className="max-w-xs mx-auto px-4 flex items-center lg:max-w-none lg:px-8">
                    <div className="ml-4 flex-auto flex flex-col">
                      ...
                      <p className="text-sm text-gray-500">
                        World class system integrator, final assembler of
                        system.
                      </p>
                    </div>
                  </div>
...
export default withUrql(Desalination)
