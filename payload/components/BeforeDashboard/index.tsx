  ...
  return (
    <div className={baseClass}>
      ...
      <ul className={`${baseClass}__instructions`}>
        <li>
          Head over to GitHub and clone the new repository to your local machine
          (it will be under the <i>GitHub Scope</i> that you selected when
        ...
        <li>
          ...
          as needed. If you are new to Payload, we also recommend you check out
          the{" "}
          <a
